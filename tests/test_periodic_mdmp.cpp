...
int main() {
    ...
    // 4. Execute the MDMP Communication
    ...
    for (int i = 0; i < size; ++i) {
        if (rank == i) {
            if (passed) {
//                std::cout << "[PASS] Rank " << rank << " | Left Ghost: " << left_ghost 
//                          << " == " << left_neighbor << " | Right Ghost: " << right_ghost 
//                         << " == " << right_neighbor << std::endl;
            } else {
