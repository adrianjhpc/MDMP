...
// 1. Replaced mpi.h with the pure MDMP interface
...
//****************************************************************************80
//
// Originally taken from https://people.math.sc.edu/Burkardt/cpp_src/satisfy_mpi/satisfy_mpi.cpp
//  
// Which is referenced from https://people.math.sc.edu/Burkardt/cpp_src/satisfy_mpi/satisfy_mpi.html  
//  
//  Purpose:
//
...
//
  ...
  //
  // Wrap the reduction in the communication region markers
  //
  MDMP_COMMREGION_BEGIN();
  MDMP_REDUCE(&solution_num_local, &solution_num, 1, 0, MDMP_SUM);
  MDMP_COMMREGION_END();
//
